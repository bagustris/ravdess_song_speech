#!/usr/bin/env python3 
# speech_librosa_hfs_cv_conv1d: script to evaluate CNN network on librosa hsf feature with cross correlation

# load needed modules
import numpy as np
from keras.models import Sequential  
from keras.layers import Dense, Activation, Flatten, Convolution1D, Flatten 
...
def create_model():  
    ...
    model.add(Convolution1D(256, 8, activation='relu'))
    model.add(Convolution1D(256, 12, activation='relu'))
    model.add(Flatten())
